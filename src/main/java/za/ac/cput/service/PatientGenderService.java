...
public class PatientGenderService implements IPatientGenderService{
    public static IPatientGenderRepository repository = null;
    ...
    public PatientGender save(PatientGender patientGender) {
        PatientGender obj = PatientGenderFactory.createPatientGender(patientGender.getPatientID(),
                                                                     patientGender.getGenderID());
